...
upload:
	cd "$(THIS_DIR)"
	echo '<!doctype html><title>please-clap</title><meta http-equiv="refresh" content="0; ./please_clap/">' \
		> ./target/doc/index.htm
	rsync -av --chmod=755 ./target/doc/ untispace:~/virtual/please-clap.unterwaditzer.net/
